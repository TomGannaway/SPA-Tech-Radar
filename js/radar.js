...
function radar_visualization(config) {
  ...
  blips.each(function(d) {
    ...
    if (d.moved > 0) {
      ...
      // add an id attribute relating to the textual description
      blip.append("circle")
        .attr("id", 'circle-' + d.id + '-' + d.quadrant + '-' + d.ring)
        .attr("onmouseover", function(d) { return "mouseOverCircle("+d.id+','+d.quadrant+','+d.ring+")"})
        .attr("onmouseout", function(d) { return "mouseOutCircle("+d.id+','+d.quadrant+','+d.ring+")"})
        .attr("r", 11)
        .attr("fill", d.color);
    }
